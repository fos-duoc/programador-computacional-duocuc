...
export const technologies: Record<string, Technology> = {
  ...
  python: {
    ...
    descripcion:
      "Python es un lenguaje de programación interpretado de alto nivel, conocido por su sintaxis clara y legible. Es extremadamente versátil, usado desde scripts simples hasta machine learning y desarrollo web.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      {
        tipo: "Certificacion",
        nombre: "PCEP – Certified Entry-Level Python",
  ...
  java: {
    ...
    descripcion:
      "Java es un lenguaje orientado a objetos, compilado a bytecode que corre en la JVM. Es el estándar para desarrollo empresarial y Android, conocido por su robustez y portabilidad.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      { tipo: "Tutorial", nombre: "Baeldung", url: "https://www.baeldung.com/" },
      {
        ...
        url: "https://education.oracle.com/java-certification-path",
      },
    ],
    primerRelease: "1995",
  ...
  javascript: {
    ...
    descripcion:
      "JavaScript es el lenguaje de programación de la web. Originalmente solo para navegadores, ahora con Node.js también corre en servidores. Es esencial para desarrollo frontend moderno.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "Traversy Media JS Crash Course",
  ...
  typescript: {
    ...
    descripcion:
      "TypeScript es un superset de JavaScript que añade tipado estático opcional. Mejora la mantenibilidad y detecta errores en tiempo de compilación.",
    usosPrincipales: [
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "TypeScript Official",
        url: "https://www.typescriptlang.org/docs/",
      },
      {
        tipo: "Tutorial",
        nombre: "TypeScript Deep Dive",
  ...
  sql: {
    ...
    descripcion:
      "SQL (Structured Query Language) es el lenguaje estándar para gestionar y consultar bases de datos relacionales. Es fundamental para cualquier desarrollador backend o data.",
    usosPrincipales: [
  ...
  spring: {
    ...
    descripcion:
      "Spring Boot es un framework que simplifica la creación de aplicaciones Java standalone, listas para producción. Es el estándar de facto para backend enterprise en Java.",
    usosPrincipales: [
      "APIs REST",
      "Microservicios",
  ...
  react: {
    ...
    descripcion:
      "React es una librería declarativa para construir interfaces de usuario basada en componentes. Desarrollada por Facebook, es la más popular para frontend moderno.",
    usosPrincipales: [
  ...
  angular: {
    ...
    descripcion:
      "Angular es un framework completo para construir aplicaciones web. Incluye todo lo necesario: routing, formularios, HTTP, testing. Ideal para aplicaciones grandes.",
    usosPrincipales: [
      "Aplicaciones empresariales",
    ...
    recursos: [
      ...
      {
        tipo: "Certificacion",
        nombre: "Google Developers Angular",
  ...
  postgresql: {
    ...
    descripcion:
      "PostgreSQL es una base de datos relacional open source conocida por su robustez, extensibilidad y cumplimiento de estándares SQL. Es la elección preferida para aplicaciones que requieren integridad de datos.",
    usosPrincipales: [
  ...
  mongodb: {
    ...
    descripcion:
      "MongoDB es una base de datos NoSQL que almacena datos en documentos JSON flexibles. Ideal para aplicaciones con esquemas cambiantes y datos semi-estructurados.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      {
        tipo: "Certificacion",
        nombre: "MongoDB Certified Developer",
  ...
  docker: {
    ...
    descripcion:
      "Docker permite empaquetar aplicaciones con todas sus dependencias en contenedores portables. Es el estándar para desarrollo y despliegue de aplicaciones modernas.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      {
        tipo: "Certificacion",
        nombre: "Docker Certified Associate",
  ...
  kubernetes: {
    ...
    descripcion:
      "Kubernetes es un sistema de orquestación de contenedores que automatiza el despliegue, escalado y gestión de aplicaciones containerizadas.",
    usosPrincipales: [
    ...
    recursos: [
      ...
      {
        tipo: "Certificacion",
        nombre: "CKA - Certified Kubernetes Administrator",
  ...
  git: {
    ...
    descripcion:
      "Git es el sistema de control de versiones más usado en el mundo. Permite trackear cambios en código, colaborar con otros desarrolladores y mantener historial completo.",
    usosPrincipales: [
    ...
    desventajas: ["Curva de aprendizaje", "Conflictos de merge", "Comandos pueden ser confusos"],
  ...
  aws: {
    ...
    descripcion:
      "AWS es la plataforma cloud más grande y completa, ofreciendo más de 200 servicios desde computación hasta machine learning.",
    usosPrincipales: [
    ...
    desventajas: ["Pricing complejo", "Curva de aprendizaje", "Puede ser costoso sin optimización"],
  ...
  azure: {
    ...
    descripcion:
      "Azure es la plataforma cloud de Microsoft, muy popular en empresas que ya usan tecnologías Microsoft como .NET, Active Directory y Office 365.",
    usosPrincipales: [
      "Aplicaciones .NET",
    ...
    desventajas: ["UI puede ser confusa", "Algunos servicios menos maduros", "Pricing complejo"],
