...
export const bestPractices: Record<string, BestPractice> = {
  ...
  solid: {
    ...
    descripcion:
      "SOLID es un acrónimo que representa cinco principios de diseño orientado a objetos que, cuando se aplican juntos, hacen que el software sea más comprensible, flexible y mantenible. Fueron popularizados por Robert C. Martin (Uncle Bob).",
    principios: [
      {
        nombre: "Single Responsibility",
        letra: "S",
        descripcion: "Una clase debe tener una única razón para cambiar",
      },
      {
        nombre: "Open/Closed",
        letra: "O",
      ...
      {
        nombre: "Liskov Substitution",
        letra: "L",
        descripcion:
          "Los objetos de una superclase deben poder reemplazarse por objetos de sus subclases",
      },
      {
        nombre: "Interface Segregation",
        letra: "I",
        descripcion: "Los clientes no deben depender de interfaces que no usan",
      },
      {
        nombre: "Dependency Inversion",
        letra: "D",
        descripcion: "Los módulos de alto nivel no deben depender de módulos de bajo nivel",
      },
    ],
    beneficios: [
...
class NotificacionService:
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "SOLID Principles (Refactoring Guru)",
        url: "https://refactoring.guru/design-patterns/solid",
      },
      {
        tipo: "Video",
        nombre: "SOLID Principles in 8 Minutes",
        url: "https://www.youtube.com/watch?v=yxf2spbpTSw",
      },
      {
        tipo: "Libro",
        nombre: "Clean Architecture - Robert C. Martin",
  ...
  dry: {
    ...
    descripcion:
      'DRY (Don\'t Repeat Yourself) es un principio que establece que cada pieza de conocimiento debe tener una representación única y autoritativa dentro de un sistema. Fue formulado por Andy Hunt y Dave Thomas en "The Pragmatic Programmer".',
    principios: [
      {
        nombre: "Single Source of Truth",
        descripcion: "Cada dato o lógica debe existir en un solo lugar",
      },
      {
        nombre: "Abstracción",
        descripcion: "Extraer patrones comunes en funciones o clases reutilizables",
      },
      {
        nombre: "Configuración centralizada",
        descripcion: "Constantes y configuraciones en un solo lugar",
      },
    ],
    beneficios: [
...
def procesar_usuario(user):
    ...
    recursos: [
      {
        tipo: "Articulo",
        nombre: "DRY Principle Explained",
  ...
  kiss: {
    ...
    descripcion:
      "KISS es un principio de diseño que establece que la mayoría de los sistemas funcionan mejor si se mantienen simples en lugar de hacerlos complicados. La simplicidad debe ser un objetivo clave del diseño y debe evitarse la complejidad innecesaria.",
    principios: [
      {
        nombre: "Evitar complejidad innecesaria",
        descripcion: "No sobreingeniería, resolver el problema actual",
      },
...
def crear_objeto():
  ...
  "clean-code": {
    ...
    descripcion:
      "Clean Code es un conjunto de prácticas para escribir código que sea fácil de leer, entender y mantener. Se basa en el libro de Robert C. Martin y enfatiza que el código se lee muchas más veces de las que se escribe.",
    principios: [
      {
        nombre: "Nombres significativos",
        descripcion: "Variables, funciones y clases con nombres que revelen intención",
      },
      ...
      {
        nombre: "Formateo consistente",
        descripcion: "Estilo de código uniforme en todo el proyecto",
      },
...
def calcular_area_rectangulo(ancho, alto):
  ...
  tdd: {
    ...
    descripcion:
      "TDD es una metodología de desarrollo donde se escriben las pruebas antes del código. Sigue el ciclo Red-Green-Refactor: escribir un test que falle, escribir el código mínimo para que pase, y luego refactorizar.",
    principios: [
...
def suma(a: int, b: int) -> int:
    ...
    recursos: [
      {
        tipo: "Libro",
        nombre: "Test Driven Development - Kent Beck",
  ...
  "design-patterns": {
    ...
    descripcion:
      "Los patrones de diseño son soluciones típicas a problemas comunes en el diseño de software. Son plantillas que describen cómo resolver un problema de diseño. Fueron catalogados por el Gang of Four (GoF) en 1994.",
    principios: [
      {
        nombre: "Creacionales",
        descripcion: "Factory, Singleton, Builder, Prototype, Abstract Factory",
      },
      {
        nombre: "Estructurales",
        descripcion: "Adapter, Decorator, Facade, Proxy, Composite, Bridge",
      },
      {
        nombre: "Comportamiento",
        descripcion: "Observer, Strategy, Command, State, Iterator, Template Method",
      },
    ],
    beneficios: [
...
payment.pay(100)`,
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "Refactoring Guru - Design Patterns",
  ...
  "data-quality": {
    ...
    descripcion:
      "Data Quality se refiere a las prácticas para asegurar que los datos sean precisos, completos, consistentes y confiables para su uso previsto. Es fundamental para tomar decisiones basadas en datos.",
    principios: [
...
expectation_suite.add_expectation(
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "Great Expectations",
        url: "https://docs.greatexpectations.io/",
      },
      {
        tipo: "Articulo",
        nombre: "Data Quality Dimensions",
        url: "https://www.dataversity.net/data-quality-dimensions/",
      },
    ],
  ...
  normalization: {
    ...
    descripcion:
      "La normalización es el proceso de organizar los datos en una base de datos para reducir la redundancia y mejorar la integridad de los datos. Define formas normales (1FN, 2FN, 3FN, BCNF) como estándares.",
    principios: [
      {
        nombre: "1FN (Primera Forma Normal)",
        descripcion: "Valores atómicos, sin grupos repetitivos",
      },
      {
        nombre: "2FN (Segunda Forma Normal)",
        descripcion: "Cumple 1FN + dependencia completa de la clave primaria",
      },
      {
        nombre: "3FN (Tercera Forma Normal)",
        descripcion: "Cumple 2FN + sin dependencias transitivas",
      },
      {
        nombre: "BCNF (Boyce-Codd)",
        descripcion: "Toda dependencia funcional es de una superclave",
      },
    ],
    beneficios: [
...
CREATE TABLE pedidos (
  ...
  "etl-best-practices": {
    ...
    descripcion:
      "Mejores prácticas para procesos de extracción, transformación y carga de datos en pipelines de datos. Incluye patrones para ETL tradicional y ELT moderno.",
    principios: [
      {
        nombre: "Idempotencia",
        descripcion: "Ejecutar múltiples veces produce el mismo resultado",
      },
...
{% endif %}`,
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "dbt Best Practices",
        url: "https://docs.getdbt.com/best-practices",
      },
      {
        tipo: "Video",
        nombre: "Modern Data Stack",
        url: "https://www.youtube.com/watch?v=9B-M4d4RBnE",
      },
    ],
  ...
  "ci-cd": {
    ...
    descripcion:
      "CI/CD es la práctica de integrar cambios de código frecuentemente y automatizar el proceso de despliegue a producción. CI (Continuous Integration) y CD (Continuous Delivery/Deployment) son prácticas fundamentales de DevOps.",
    principios: [
...
jobs:
  ...
  gitflow: {
    ...
    descripcion:
      "GitFlow es un modelo de branching para Git que define roles específicos para diferentes ramas y cómo deben interactuar. Fue propuesto por Vincent Driessen y es ampliamente adoptado.",
    principios: [
...
git branch -d feature/nueva-funcionalidad`,
    ...
    recursos: [
      {
        tipo: "Articulo",
        nombre: "GitFlow Original",
        url: "https://nvie.com/posts/a-successful-git-branching-model/",
      },
      {
        tipo: "Tutorial",
        nombre: "Atlassian GitFlow",
  ...
  iac: {
    ...
    descripcion:
      "IaC es la práctica de gestionar y provisionar infraestructura mediante archivos de configuración en lugar de procesos manuales. Permite versionar, revisar y automatizar la infraestructura.",
    principios: [
...
resource "aws_instance" "web" {
  ...
  containerization: {
    ...
    descripcion:
      "La containerización es el empaquetado de código junto con todas sus dependencias para que pueda ejecutarse de manera consistente en cualquier entorno. Docker es la tecnología más popular.",
    principios: [
      {
        nombre: "Imágenes inmutables",
        descripcion: "Las imágenes no cambian después de construirse",
      },
...
CMD ["node", "server.js"]`,
  ...
  "well-architected": {
    ...
    descripcion:
      "El Well-Architected Framework es un conjunto de mejores prácticas para diseñar y operar sistemas confiables, seguros, eficientes y rentables en la nube. Desarrollado por AWS y adoptado por Azure y GCP.",
    principios: [
      {
        nombre: "Excelencia Operacional",
        descripcion: "Ejecutar y monitorear sistemas, mejora continua",
      },
    ...
    recursos: [
      {
        tipo: "Documentacion",
        nombre: "AWS Well-Architected",
        url: "https://aws.amazon.com/architecture/well-architected/",
      },
      {
        tipo: "Documentacion",
        nombre: "Azure Well-Architected",
  ...
  "security-cloud": {
    ...
    descripcion:
      "Prácticas de seguridad específicas para entornos cloud, incluyendo identity management, encriptación, seguridad de red y cumplimiento regulatorio.",
    principios: [
  ...
  microservices: {
    ...
    descripcion:
      "Los microservicios son un estilo arquitectónico que estructura una aplicación como una colección de servicios pequeños, autónomos y desplegables independientemente. Cada servicio tiene su propia base de datos y se comunica via APIs.",
    principios: [
  ...
  "clean-architecture": {
    ...
    descripcion:
      "Clean Architecture es un patrón que organiza el código en capas concéntricas con el dominio de negocio en el centro, aislado de frameworks y detalles externos. Propuesto por Robert C. Martin (Uncle Bob).",
    principios: [
...
└── main.py           # Composición y DI`,
  ...
  "event-driven": {
    ...
    descripcion:
      "La arquitectura orientada a eventos es un patrón donde la producción, detección y consumo de eventos determina el flujo del programa. Ideal para sistemas distribuidos y microservicios.",
    principios: [
      {
        nombre: "Eventos inmutables",
        descripcion: "Los eventos no se modifican después de emitirse",
      },
...
event_bus.publish(OrderCreatedEvent(
    ...
    recursos: [
      {
        tipo: "Libro",
        nombre: "Designing Event-Driven Systems",
  ...
  cqrs: {
    ...
    descripcion:
      "CQRS (Command Query Responsibility Segregation) es un patrón que separa las operaciones de lectura y escritura en modelos diferentes. Permite optimizar cada lado independientemente.",
    principios: [
      {
        nombre: "Commands",
        descripcion: "Operaciones que modifican estado (Create, Update, Delete)",
      },
      { nombre: "Queries", descripcion: "Operaciones que leen estado sin modificar" },
      {
        nombre: "Modelos separados",
        descripcion: "Modelo de escritura vs modelo de lectura optimizados",
      },
...
class GetOrderHandler:
  ...
  "api-design": {
    ...
    descripcion:
      "Prácticas para diseñar APIs que sean intuitivas, consistentes y fáciles de usar. Incluye principios REST, versionado, paginación, manejo de errores y documentación.",
    principios: [
...
# Respuesta con paginación
{
  ...
  yagni: {
    ...
    descripcion:
      "YAGNI (You Aren't Gonna Need It) es un principio de Extreme Programming que establece que no debes agregar funcionalidad hasta que sea necesaria. Evita la sobreingeniería.",
    principios: [
      { nombre: "Implementar solo lo necesario", descripcion: "No código especulativo" },
      {
        nombre: "Evitar abstracciones prematuras",
        descripcion: "Esperar hasta tener 3+ casos de uso",
      },
  ...
  observability: {
    ...
    descripcion:
      "Observabilidad es la capacidad de entender el estado interno de un sistema a partir de sus outputs. Se basa en tres pilares: logs, métricas y trazas distribuidas.",
    principios: [
      { nombre: "Logs", descripcion: "Registro de eventos con contexto" },
      {
        nombre: "Métricas",
        descripcion: "Datos numéricos agregados (latencia, errores, saturación)",
      },
...
# {"event": "order_created", "order_id": "ORD-123", ...}`,
    ...
    recursos: [
      ...
      {
        tipo: "Articulo",
        nombre: "Three Pillars of Observability",
  ...
  "twelve-factor": {
    ...
    descripcion:
      "The Twelve-Factor App es una metodología para construir aplicaciones software-as-a-service que son portables, escalables y mantenibles. Creada por desarrolladores de Heroku.",
    principios: [
      ...
      {
        nombre: "IV. Backing Services",
        descripcion: "Tratar servicios externos como recursos adjuntos",
      },
    ...
    ejemplos: [],
    recursos: [{ tipo: "Documentacion", nombre: "12factor.net", url: "https://12factor.net/" }],
