...
export const questions: Question[] = [
  // JavaScript Questions
  {
    ...
    correctAnswer: 2,
    explanation:
      'En JavaScript, typeof null retorna "object". Esto es un bug histórico que se mantiene por compatibilidad.',
  },
  {
    id: "js-002",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "push() agrega elementos al final del array. unshift() los agrega al inicio, pop() remueve del final, y shift() del inicio.",
  },
  {
    id: "js-003",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "Debido a la representación de punto flotante en JavaScript, 0.1 + 0.2 da 0.30000000000000004, no exactamente 0.3.",
  },
  {
    id: "js-004",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "Una closure es una función que recuerda y tiene acceso a las variables del scope en el que fue creada, incluso después de que ese scope haya terminado de ejecutarse.",
  },
  {
    id: "js-005",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "let tiene alcance de bloque (block scope), mientras que var tiene alcance de función (function scope). Además, let no sufre de hoisting de la misma manera que var.",
  },
  {
    id: "js-006",
    category: "javascript",
    ...
    correctAnswer: 0,
    explanation:
      "JSON.parse() convierte un string JSON a un objeto JavaScript. JSON.stringify() hace lo contrario, convierte un objeto a string JSON.",
  },
  {
    id: "js-007",
    category: "javascript",
...
console.log(obj.a);`,
    ...
    correctAnswer: 0,
    explanation:
      "Object.freeze() hace que un objeto sea inmutable. Intentar modificar una propiedad de un objeto congelado falla silenciosamente (o lanza error en strict mode).",
  },
  {
    id: "js-008",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "El Event Loop es el mecanismo que permite a JavaScript ejecutar código asíncrono, manejando el call stack y las callback queues.",
  },
  {
    id: "js-009",
    category: "javascript",
    ...
    correctAnswer: 2,
    explanation:
      "const se usa para declarar constantes. Una vez asignado, el valor no puede ser reasignado (aunque objetos y arrays pueden ser mutados).",
  },
  {
    id: "js-010",
    category: "javascript",
...
console.log(test());`,
    ...
    correctAnswer: 1,
    explanation:
      "Las funciones async siempre retornan una Promise. Aunque retornamos 1, el resultado es una Promise que resuelve a 1.",
  },
  {
    id: "js-011",
    category: "javascript",
...
console.log('4');`,
    ...
    correctAnswer: 2,
    explanation:
      "El Event Loop ejecuta: 1) código síncrono (1, 4), 2) microtasks/promises (3), 3) macrotasks/setTimeout (2). Las Promises tienen prioridad sobre setTimeout.",
  },
  {
    id: "js-012",
    category: "javascript",
...
console.log(arr2);`,
    ...
    correctAnswer: 0,
    explanation:
      "El spread operator crea una copia superficial de los elementos. Los cambios posteriores a arr1 no afectan a arr2.",
  },
  {
    id: "js-013",
    category: "javascript",
    ...
    correctAnswer: 3,
    explanation:
      "map() retorna un nuevo array sin modificar el original. push(), splice() y sort() mutan el array original.",
  },
  {
    id: "js-014",
    category: "javascript",
...
console.log(a, b, rest);`,
    ...
    correctAnswer: 1,
    explanation:
      "La destructuración asigna a=1, b usa el valor por defecto 10 (porque no existe b en el objeto), y rest captura las propiedades restantes.",
  },
  {
    id: "js-015",
    category: "javascript",
    ...
    correctAnswer: 2,
    explanation:
      'Las arrow functions no tienen su propio "this". Usan el "this" del scope léxico donde fueron definidas, no donde se ejecutan.',
  },
  {
    id: "js-016",
    category: "javascript",
...
console.log(1 === '1');`,
    ...
    correctAnswer: 2,
    explanation:
      '== realiza coerción de tipos (1 == "1" es true), mientras que === compara valor Y tipo sin coerción (1 === "1" es false).',
  },
  {
    id: "js-017",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      'Promise.all() tiene comportamiento "fail-fast": si cualquier promesa rechaza, todo el Promise.all() rechaza inmediatamente con ese error.',
  },
  {
    id: "js-018",
    category: "javascript",
...
console.log(a, b);`,
    ...
    correctAnswer: 1,
    explanation:
      '?? solo usa el valor por defecto si el lado izquierdo es null o undefined. A diferencia de ||, no trata 0, "" o false como falsy.',
  },
  {
    id: "js-019",
    category: "javascript",
    ...
    correctAnswer: 1,
    explanation:
      "Symbol crea valores primitivos únicos, usados principalmente como claves de propiedades que no colisionan con otras propiedades del objeto.",
  },
  {
    id: "js-020",
    category: "javascript",
...
// Después del garbage collection...`,
    ...
    correctAnswer: 1,
    explanation:
      "WeakMap tiene referencias débiles a sus claves. Si no hay otra referencia al objeto, puede ser garbage collected junto con su entry en el WeakMap.",
  },
  ...
  // Python Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "En Python, [] crea una lista (list), no un array. Los arrays son parte del módulo array.",
  },
  {
    id: "py-002",
    category: "python",
    ...
    correctAnswer: 2,
    explanation:
      "append() agrega un elemento al final de la lista. insert() permite especificar la posición.",
  },
  {
    id: "py-003",
    category: "python",
...
print(x)`,
    ...
    correctAnswer: 1,
    explanation:
      "En Python, las listas son mutables y se pasan por referencia. y = x crea una referencia al mismo objeto, no una copia.",
  },
  {
    id: "py-004",
    category: "python",
    ...
    correctAnswer: 1,
    explanation:
      "List comprehension es una forma elegante y concisa de crear listas en Python. El ejemplo crea [0, 1, 4, 9, 16].",
  },
  {
    id: "py-005",
    category: "python",
    ...
    correctAnswer: 1,
    explanation:
      "== compara si dos objetos tienen el mismo valor, mientras que is compara si son el mismo objeto en memoria.",
  },
  {
    id: "py-006",
    category: "python",
    ...
    correctAnswer: 1,
    explanation:
      "@staticmethod define un método que no recibe self (instancia) ni cls (clase), funcionando como una función regular dentro de la clase.",
  },
  {
    id: "py-007",
    category: "python",
...
print(func(2))`,
    ...
    correctAnswer: 1,
    explanation:
      "Los argumentos por defecto mutables (como listas) se evalúan una sola vez. La misma lista se reutiliza en cada llamada.",
  },
  {
    id: "py-008",
    category: "python",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Un generator es una función que usa yield para retornar valores uno a la vez, manteniendo su estado entre llamadas.",
  },
  {
    id: "py-010",
    category: "python",
    ...
    correctAnswer: 1,
    explanation:
      "El GIL es un mutex que protege el acceso a objetos Python, permitiendo solo un thread ejecutar bytecode a la vez, limitando el paralelismo real.",
  },
  ...
  // SQL Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "WHERE filtra filas antes del agrupamiento, HAVING filtra después del GROUP BY sobre los grupos resultantes.",
  },
  {
    id: "sql-002",
    category: "sql",
    ...
    options: ["Ordena los resultados", "Elimina filas duplicadas", "Cuenta filas", "Une tablas"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "INNER JOIN retorna solo filas que coinciden en ambas tablas. LEFT JOIN retorna todas las filas de la tabla izquierda y las coincidencias de la derecha.",
  },
  {
    id: "sql-004",
    category: "sql",
    ...
    correctAnswer: 0,
    explanation:
      "COUNT(*) cuenta todas las filas incluyendo NULLs. COUNT(column) solo cuenta valores no NULL de esa columna.",
  },
  {
    id: "sql-005",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "Una subquery correlacionada hace referencia a columnas de la query externa, ejecutándose una vez por cada fila de la query principal.",
  },
  {
    id: "sql-006",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "Un índice clustered determina el orden físico de almacenamiento de las filas. Solo puede haber uno por tabla.",
  },
  {
    id: "sql-007",
    category: "sql",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "La normalización organiza las tablas y relaciones para minimizar la redundancia de datos y mejorar la integridad.",
  },
  {
    id: "sql-009",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "ACID son las propiedades que garantizan transacciones confiables: Atomicidad, Consistencia, Aislamiento y Durabilidad.",
  },
  {
    id: "sql-010",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "COALESCE retorna el primer valor no NULL de la lista de argumentos. Es útil para manejar NULLs.",
  },
  ...
  // SQL Questions - Alineadas con MDY1101/MDY3131 DuocUC
  {
    ...
    correctAnswer: 2,
    explanation:
      "CREATE TABLE es el comando DDL para crear tablas. Se especifica el nombre y las columnas con sus tipos de datos.",
  },
  {
    id: "sql-012",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "La PRIMARY KEY identifica de forma única cada registro de una tabla. No permite valores NULL ni duplicados.",
  },
  {
    id: "sql-013",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "La FOREIGN KEY crea una relación entre tablas, referenciando la PRIMARY KEY de otra tabla para mantener integridad referencial.",
  },
  {
    id: "sql-014",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "DELETE permite WHERE para eliminar registros específicos y se puede revertir con ROLLBACK. TRUNCATE elimina todo sin log de transacción.",
  },
  {
    id: "sql-015",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "1FN requiere que cada celda contenga un solo valor (atómico), eliminando grupos repetitivos y atributos multivaluados.",
  },
  {
    id: "sql-016",
    category: "sql",
    ...
    difficulty: "intermediate",
    question:
      "¿Qué tipo de relación representa un diagrama donde un Cliente puede tener muchos Pedidos?",
    options: ["Uno a Uno (1:1)", "Uno a Muchos (1:N)", "Muchos a Muchos (N:M)", "Ninguna relación"],
    correctAnswer: 1,
    explanation:
      "Una relación 1:N (Uno a Muchos) significa que un registro de una tabla se relaciona con múltiples registros de otra. Un Cliente tiene muchos Pedidos.",
  },
  {
    id: "sql-017",
    category: "sql",
    ...
    correctAnswer: 2,
    explanation:
      "UPDATE modifica datos existentes en una tabla. ALTER modifica la estructura de la tabla, no los datos.",
  },
  {
    id: "sql-018",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "Un Stored Procedure es código SQL compilado y guardado en el servidor que se puede llamar por nombre, acepta parámetros y mejora rendimiento.",
  },
  {
    id: "sql-019",
    category: "sql",
...
COMMIT;`,
    ...
    correctAnswer: 1,
    explanation:
      "Una transacción agrupa operaciones que deben ejecutarse todas (COMMIT) o ninguna (ROLLBACK), garantizando integridad de datos.",
  },
  {
    id: "sql-020",
    category: "sql",
    ...
    correctAnswer: 1,
    explanation:
      "Un Trigger es código que se dispara automáticamente cuando ocurren eventos específicos (INSERT, UPDATE, DELETE) en una tabla.",
  },
  ...
  // AWS Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "Amazon S3 (Simple Storage Service) es el servicio de almacenamiento de objetos de AWS, ideal para archivos, backups, y contenido estático.",
  },
  {
    id: "aws-002",
    category: "aws",
    ...
    correctAnswer: 1,
    explanation:
      "Amazon EC2 (Elastic Compute Cloud) proporciona capacidad de computación escalable en la nube, permitiendo lanzar servidores virtuales.",
  },
  {
    id: "aws-003",
    category: "aws",
    ...
    correctAnswer: 2,
    explanation:
      "En el modelo de responsabilidad compartida, AWS gestiona la seguridad DE la nube (infraestructura), y el cliente gestiona la seguridad EN la nube (datos, apps, configuración).",
  },
  {
    id: "aws-004",
    category: "aws",
    ...
    correctAnswer: 2,
    explanation:
      "AWS Lambda permite ejecutar código sin aprovisionar servidores. Solo pagas por el tiempo de ejecución.",
  },
  {
    id: "aws-005",
    category: "aws",
    ...
    correctAnswer: 0,
    explanation:
      "VPC (Virtual Private Cloud) es una red virtual aislada lógicamente en AWS donde puedes lanzar recursos.",
  },
  {
    id: "aws-006",
    category: "aws",
    ...
    correctAnswer: 1,
    explanation:
      "RDS es un servicio de base de datos relacional (MySQL, PostgreSQL, etc.), mientras DynamoDB es NoSQL key-value.",
  },
  {
    id: "aws-007",
    category: "aws",
    ...
    correctAnswer: 1,
    explanation:
      "Amazon CloudFront es el servicio de CDN que distribuye contenido globalmente con baja latencia.",
  },
  {
    id: "aws-008",
    category: "aws",
    ...
    correctAnswer: 1,
    explanation:
      "IAM (Identity and Access Management) permite gestionar usuarios, grupos, roles y permisos de acceso a recursos AWS.",
  },
  {
    id: "aws-009",
    category: "aws",
    ...
    difficulty: "intermediate",
    question:
      "¿Qué clases de almacenamiento S3 son las más económicas para datos raramente accedidos?",
    options: [
      "S3 Standard",
    ...
    correctAnswer: 1,
    explanation:
      "S3 Glacier y Glacier Deep Archive son las opciones más económicas para archivado de largo plazo con acceso poco frecuente.",
  },
  {
    id: "aws-010",
    category: "aws",
    ...
    options: ["Servicio de routing de red", "Servicio de DNS", "Balanceador de carga", "Firewall"],
    correctAnswer: 1,
    explanation:
      "Amazon Route 53 es el servicio de DNS de AWS, que también ofrece health checks y routing policies.",
  },
  ...
  // Docker Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "Una imagen Docker es un template inmutable. Un contenedor es una instancia en ejecución de esa imagen.",
  },
  {
    id: "docker-002",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "docker ps lista los contenedores en ejecución. docker ps -a lista todos, incluyendo los detenidos.",
  },
  {
    id: "docker-003",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "RUN ejecuta comandos durante el build de la imagen. CMD define el comando por defecto cuando el contenedor inicia.",
  },
  {
    id: "docker-004",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "ENTRYPOINT configura el contenedor como un ejecutable. CMD proporciona argumentos por defecto que pueden ser sobrescritos.",
  },
  {
    id: "docker-005",
    category: "docker",
    ...
    correctAnswer: 0,
    explanation:
      "La flag -p (publish) mapea puertos. -p host:container, por ejemplo -p 8080:80 mapea el puerto 80 del contenedor al 8080 del host.",
  },
  {
    id: "docker-006",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "Los volumes permiten persistir datos generados por contenedores, almacenándolos fuera del sistema de archivos del contenedor.",
  },
  {
    id: "docker-007",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "Docker Compose permite definir y ejecutar aplicaciones multi-contenedor usando un archivo YAML (docker-compose.yml).",
  },
  {
    id: "docker-008",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "COPY copia archivos o directorios del contexto de build (host) a la imagen Docker.",
  },
  {
    id: "docker-009",
    category: "docker",
    ...
    correctAnswer: 1,
    explanation:
      "Multi-stage builds permiten usar múltiples FROM en un Dockerfile, copiando solo los artefactos necesarios a la imagen final, reduciendo su tamaño.",
  },
  {
    id: "docker-010",
    category: "docker",
    ...
    correctAnswer: 2,
    explanation:
      "Las imágenes se almacenan localmente en el sistema de archivos del Docker daemon. Docker Hub es un registro remoto opcional.",
  },
  ...
  // Java Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "== compara referencias de objetos (si apuntan al mismo objeto en memoria), mientras que .equals() compara el contenido de los objetos.",
  },
  {
    id: "java-002",
    category: "java",
    ...
    correctAnswer: 0,
    explanation:
      'JVM (Java Virtual Machine) es la máquina virtual que ejecuta bytecode Java, permitiendo la portabilidad "Write Once, Run Anywhere".',
  },
  {
    id: "java-003",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "ArrayList usa un array redimensionable (rápido para acceso por índice), LinkedList usa nodos doblemente enlazados (rápido para inserciones/eliminaciones).",
  },
  {
    id: "java-004",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "Los Streams permiten procesar colecciones de forma declarativa con operaciones como filter, map, reduce.",
  },
  {
    id: "java-005",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "final hace que una variable no pueda ser reasignada. Para objetos, la referencia es final pero el objeto puede ser mutado.",
  },
  {
    id: "java-006",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "La herencia permite que una clase (subclase) herede atributos y métodos de otra (superclase) usando extends.",
  },
  {
    id: "java-007",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "El Garbage Collector libera automáticamente la memoria ocupada por objetos que ya no tienen referencias, evitando memory leaks.",
  },
  {
    id: "java-008",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "Una interfaz define un contrato de métodos (y desde Java 8, puede tener default methods). Las clases implementan interfaces con implements.",
  },
  {
    id: "java-009",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "synchronized asegura que solo un thread a la vez pueda acceder a un bloque o método, previniendo condiciones de carrera.",
  },
  {
    id: "java-010",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "El método main(String[] args) es el punto de entrada. Debe ser public, static, void y recibir un array de String.",
  },
  ...
  // Java POO Questions - Alineadas con PRY2202 DuocUC
  {
    ...
    correctAnswer: 1,
    explanation:
      "Los 4 pilares de POO son: Encapsulamiento (ocultar datos), Herencia (reutilizar código), Polimorfismo (múltiples formas) y Abstracción (ocultar complejidad).",
  },
  {
    id: "java-012",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "El Encapsulamiento protege los datos internos de una clase haciendo los atributos private y proporcionando métodos public (getters/setters) para accederlos.",
  },
  {
    id: "java-013",
    category: "java",
    ...
    correctAnswer: 2,
    explanation:
      "extends se usa para herencia de clases. implements es para interfaces. super se usa para llamar al constructor o método de la clase padre.",
  },
  {
    id: "java-014",
    category: "java",
...
animal.hacerSonido(); // "Guau"`,
    ...
    correctAnswer: 1,
    explanation:
      "El Polimorfismo permite que una referencia de tipo padre apunte a objetos de clases hijas, y el método ejecutado depende del tipo real del objeto.",
  },
  {
    id: "java-015",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "Una clase abstracta puede tener métodos concretos, atributos y constructor. Una interfaz (pre-Java 8) solo tenía métodos abstractos. Desde Java 8, interfaces pueden tener default methods.",
  },
  {
    id: "java-016",
    category: "java",
    ...
    correctAnswer: 3,
    explanation:
      "private: solo la misma clase. default: mismo paquete. protected: mismo paquete + subclases. public: acceso desde cualquier lugar.",
  },
  {
    id: "java-017",
    category: "java",
    ...
    correctAnswer: 1,
    explanation:
      "Un constructor es un método especial sin tipo de retorno que tiene el mismo nombre de la clase y se ejecuta al crear un objeto con new.",
  },
  {
    id: "java-018",
    category: "java",
    ...
    correctAnswer: 0,
    explanation:
      "Single Responsibility Principle (SRP): Una clase debe tener una única responsabilidad o razón para cambiar. Mejora mantenibilidad y cohesión.",
  },
  {
    id: "java-019",
    category: "java",
...
public double sumar(double a, double b) { ... }`,
    ...
    correctAnswer: 1,
    explanation:
      "Overloading es tener múltiples métodos con el mismo nombre pero diferente firma (número o tipo de parámetros). Se resuelve en tiempo de compilación.",
  },
  {
    id: "java-020",
    category: "java",
...
class Perro extends Animal {
    ...
    correctAnswer: 1,
    explanation:
      "Overriding es redefinir un método de la clase padre en la subclase con la misma firma. Permite polimorfismo en tiempo de ejecución.",
  },
  ...
  // Snowflake Questions
  {
    ...
    options: ["Shared-disk", "Shared-nothing", "Multi-cluster shared data", "Monolítica"],
    correctAnswer: 2,
    explanation:
      'Snowflake usa una arquitectura única de "multi-cluster shared data" que separa storage, compute y servicios en capas independientes.',
  },
  {
    id: "snow-002",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Un Virtual Warehouse es un clúster de recursos de cómputo (CPU, memoria, SSD) que ejecuta queries. Se puede escalar independientemente.",
  },
  {
    id: "snow-003",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Time Travel permite acceder a datos históricos (antes de cambios/eliminaciones) hasta 90 días en Enterprise Edition.",
  },
  {
    id: "snow-004",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Zero-Copy Cloning crea copias lógicas instantáneas sin duplicar storage. Los datos se comparten hasta que se modifican.",
  },
  {
    id: "snow-005",
    category: "snowflake",
    ...
    options: ["Solo AWS", "AWS y Azure", "AWS, Azure y GCP", "Solo nube privada"],
    correctAnswer: 2,
    explanation:
      "Snowflake está disponible en AWS, Microsoft Azure y Google Cloud Platform, permitiendo multi-cloud.",
  },
  {
    id: "snow-006",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Un Stage es una ubicación (interna o externa) donde se almacenan archivos para cargarlos en tablas usando COPY INTO.",
  },
  {
    id: "snow-007",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Snowpipe carga datos automáticamente cuando nuevos archivos llegan al stage, usando un modelo serverless.",
  },
  {
    id: "snow-008",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Snowflake cobra por créditos basados en el tamaño del warehouse y tiempo de ejecución (por segundo, mínimo 60s).",
  },
  {
    id: "snow-009",
    category: "snowflake",
    ...
    correctAnswer: 1,
    explanation:
      "Fail-safe proporciona 7 días adicionales de protección de datos después de Time Travel, solo accesible por soporte de Snowflake.",
  },
  {
    id: "snow-010",
    category: "snowflake",
    ...
    options: ["MySQL", "T-SQL", "ANSI SQL con extensiones propias", "PL/SQL"],
    correctAnswer: 2,
    explanation:
      "Snowflake soporta ANSI SQL estándar con extensiones propias para funcionalidades específicas de la plataforma.",
  },
  ...
  // Databricks Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "Apache Spark es un motor de procesamiento distribuido para Big Data, soportando batch, streaming, ML y SQL.",
  },
  {
    id: "dbx-002",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Un DataFrame es una colección distribuida de datos organizada en columnas con nombre, similar a una tabla SQL o pandas DataFrame.",
  },
  {
    id: "dbx-003",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Delta Lake es una capa open-source sobre data lakes que proporciona transacciones ACID, time travel y schema enforcement.",
  },
  {
    id: "dbx-004",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Las transformations son lazy (no ejecutan hasta que se necesitan). Las actions (collect, count, write) disparan la ejecución del plan.",
  },
  {
    id: "dbx-005",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Los Notebooks son documentos interactivos que combinan código (Python, Scala, SQL, R), visualizaciones y markdown.",
  },
  {
    id: "dbx-006",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Un Cluster es un conjunto de VMs que ejecutan Spark. Puede ser all-purpose (interactivo) o job cluster (para trabajos).",
  },
  {
    id: "dbx-007",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Unity Catalog proporciona gobernanza centralizada, lineage, control de acceso y descubrimiento de datos en toda la plataforma.",
  },
  {
    id: "dbx-008",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "La arquitectura Lakehouse combina la flexibilidad de data lakes con las capacidades ACID y rendimiento de data warehouses.",
  },
  {
    id: "dbx-009",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "MLflow gestiona experimentos, empaquetado de modelos, deploy y registro de modelos a lo largo del ciclo de vida ML.",
  },
  {
    id: "dbx-010",
    category: "databricks",
    ...
    correctAnswer: 1,
    explanation:
      "Photon es el motor de ejecución C++ de Databricks que acelera queries SQL y DataFrame hasta 12x sobre Spark estándar.",
  },
  ...
  // Linux/CLI Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "ls (list) muestra archivos y directorios. Opciones comunes: ls -la (todos los archivos con detalles), ls -lh (tamaños legibles).",
  },
  {
    id: "linux-002",
    category: "linux",
    ...
    correctAnswer: 1,
    explanation:
      "755 significa: owner (7=rwx), group (5=r-x), others (5=r-x). Común para scripts ejecutables.",
  },
  {
    id: "linux-003",
    category: "linux",
    ...
    correctAnswer: 1,
    explanation:
      "El pipe conecta stdout de un comando con stdin del siguiente, permitiendo encadenar comandos: ls | grep txt",
  },
  {
    id: "linux-004",
    category: "linux",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'grep busca líneas que coincidan con un patrón. Ejemplo: grep "error" log.txt | grep -i (case insensitive).',
  },
  {
    id: "linux-006",
    category: "linux",
    ...
    correctAnswer: 1,
    explanation:
      "sudo (superuser do) ejecuta comandos como root u otro usuario con privilegios elevados.",
  },
  {
    id: "linux-007",
    category: "linux",
    ...
    correctAnswer: 1,
    explanation:
      "Un proceso zombie ha terminado pero su padre no ha recogido su exit status con wait(). Aparece como Z en ps.",
  },
  {
    id: "linux-008",
    category: "linux",
    ...
    correctAnswer: 1,
    explanation:
      "crontab permite programar tareas (cron jobs) para ejecutarse automáticamente en horarios definidos.",
  },
  {
    id: "linux-009",
    category: "linux",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Un inode contiene metadatos del archivo (permisos, propietario, timestamps, ubicación de bloques) excepto el nombre.",
  },
  ...
  // Hardware Questions
  {
    ...
    correctAnswer: 1,
    explanation:
      "RAM (Random Access Memory) es memoria volátil que almacena datos e instrucciones que el CPU necesita acceder rápidamente.",
  },
  {
    id: "hw-002",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "La CPU (Central Processing Unit) es el cerebro del computador, ejecutando instrucciones y realizando cálculos.",
  },
  {
    id: "hw-003",
    category: "hardware",
    ...
    correctAnswer: 0,
    explanation:
      "SSD usa chips de memoria flash (más rápido, sin partes móviles). HDD usa platos magnéticos giratorios (más capacidad por $).",
  },
  {
    id: "hw-004",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "La motherboard (placa base) es el PCB principal que interconecta CPU, RAM, storage, GPU y demás componentes.",
  },
  {
    id: "hw-005",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "La GPU procesa gráficos y cálculos paralelos. Usado para gaming, rendering, ML y procesamiento de video.",
  },
  {
    id: "hw-006",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "PCIe (Peripheral Component Interconnect Express) es el bus estándar para conectar GPUs, SSDs NVMe, tarjetas de red, etc.",
  },
  {
    id: "hw-007",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "ECC (Error-Correcting Code) RAM detecta y corrige errores de memoria, esencial en servidores y workstations.",
  },
  {
    id: "hw-008",
    category: "hardware",
    ...
    correctAnswer: 1,
    explanation:
      "BIOS/UEFI es firmware en la motherboard que inicializa hardware, ejecuta POST y carga el bootloader del SO.",
  },
  {
    id: "hw-009",
    category: "hardware",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "RAID 5 distribuye datos y paridad entre 3+ discos. Tolera el fallo de 1 disco manteniendo rendimiento y capacidad.",
  },
  ...
  // ============== IDS: ARCHITECTURE QUESTIONS ==============
  {
    ...
    correctAnswer: 1,
    explanation:
      "Clean Architecture tiene 4 capas concéntricas: Entities (reglas de negocio), Use Cases (aplicación), Interface Adapters (presentación), Frameworks & Drivers (infraestructura).",
  },
  {
    id: "arch-002",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "La Dependency Rule establece que las dependencias de código fuente solo pueden apuntar hacia adentro. Las capas internas no conocen nada de las externas.",
  },
  {
    id: "arch-003",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "Un Bounded Context es un límite donde un modelo de dominio es válido. Cada contexto tiene su propio Ubiquitous Language y puede tener diferentes representaciones de conceptos.",
  },
  {
    id: "arch-004",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "Un Aggregate es un grupo de entidades y value objects tratados como unidad. Tiene un Aggregate Root que es el único punto de acceso para modificaciones.",
  },
  {
    id: "arch-005",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "Event Sourcing guarda todos los cambios de estado como eventos inmutables. El estado actual se reconstruye reproduciendo la secuencia de eventos.",
  },
  {
    id: "arch-006",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "CQRS separa las operaciones de lectura y escritura en modelos diferentes. Permite optimizar cada uno independientemente y escalar de forma diferenciada.",
  },
  {
    id: "arch-007",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "Hexagonal Architecture coloca la lógica de negocio en el centro. Los Ports definen interfaces y los Adapters implementan la comunicación con el exterior.",
  },
  {
    id: "arch-008",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "Los microservicios permiten equipos autónomos, deploy independiente, escalado granular y uso de tecnologías específicas por servicio.",
  },
  {
    id: "arch-009",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "El Saga Pattern coordina transacciones distribuidas como secuencia de transacciones locales con acciones de compensación si algo falla.",
  },
  {
    id: "arch-010",
    category: "architecture",
    ...
    correctAnswer: 1,
    explanation:
      "El API Gateway es el punto de entrada único que maneja routing, autenticación, rate limiting, y agregación de respuestas.",
  },
  ...
  // ============== IDS: DEVOPS QUESTIONS ==============
  {
    ...
    correctAnswer: 1,
    explanation:
      "Un Pod es la unidad mínima en K8s. Contiene uno o más contenedores que comparten namespace de red, IP y volúmenes.",
  },
  {
    id: "devops-002",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "Un Deployment declara el estado deseado de pods, gestiona ReplicaSets, y permite rolling updates y rollbacks.",
  },
  {
    id: "devops-003",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "Un Service proporciona una IP estable y DNS para acceder a pods. Tipos: ClusterIP, NodePort, LoadBalancer, ExternalName.",
  },
  {
    id: "devops-004",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "IaC permite definir infraestructura en código, habilitando versionado, revisión, automatización y reproducibilidad.",
  },
  {
    id: "devops-005",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "terraform plan genera un plan de ejecución mostrando qué se creará/modificará/destruirá. terraform apply ejecuta esos cambios.",
  },
  {
    id: "devops-006",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "GitOps usa Git como fuente de verdad. Los cambios en Git disparan reconciliación automática del estado deseado vs actual.",
  },
  {
    id: "devops-007",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "ArgoCD es una herramienta GitOps que sincroniza continuamente el estado de Kubernetes con configuraciones en Git.",
  },
  {
    id: "devops-008",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "Helm es el package manager de K8s. Los Charts son paquetes con templates YAML y values.yaml para configuración.",
  },
  {
    id: "devops-009",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "ConfigMap almacena datos de configuración no sensibles. Se pueden montar como volumen o exponer como variables de entorno.",
  },
  {
    id: "devops-010",
    category: "devops",
    ...
    correctAnswer: 1,
    explanation:
      "Secret es similar a ConfigMap pero para datos sensibles. Los valores se almacenan en base64 y tienen restricciones de acceso adicionales.",
  },
  ...
  // ============== IDS: TESTING QUESTIONS ==============
  {
    ...
    correctAnswer: 1,
    explanation:
      "TDD sigue el ciclo: Red (escribir test que falla), Green (escribir código mínimo para pasar), Refactor (mejorar código manteniendo tests verdes).",
  },
  {
    id: "test-002",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "BDD describe comportamientos en lenguaje natural: Given (contexto), When (acción), Then (resultado esperado). Herramientas: Cucumber, SpecFlow.",
  },
  {
    id: "test-003",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "Contract Testing verifica que consumidores y proveedores de APIs cumplen un contrato acordado. Herramientas: Pact, Spring Cloud Contract.",
  },
  {
    id: "test-004",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      'Mutation Testing evalúa la calidad de los tests introduciendo mutaciones en el código. Un buen test suite debe "matar" los mutantes.',
  },
  {
    id: "test-005",
    category: "testing",
    ...
    correctAnswer: 2,
    explanation:
      "La pirámide de testing sugiere: 70% Unit Tests (base), 20% Integration Tests (medio), 10% E2E Tests (cima).",
  },
  {
    id: "test-006",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "Un Mock es un objeto que simula el comportamiento de dependencias reales, permitiendo tests aislados y controlados.",
  },
  {
    id: "test-007",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "Un Stub provee respuestas fijas sin verificar cómo fue llamado. Un Mock permite verificar que métodos fueron llamados correctamente.",
  },
  {
    id: "test-008",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "Los Integration Tests verifican que múltiples componentes funcionan correctamente juntos (ej: servicio + base de datos).",
  },
  {
    id: "test-009",
    category: "testing",
    ...
    options: ["JUnit", "Playwright, Cypress, o Selenium", "Mockito", "Maven"],
    correctAnswer: 1,
    explanation:
      "Playwright, Cypress y Selenium son frameworks para E2E testing que automatizan interacciones de navegador como un usuario real.",
  },
  {
    id: "test-010",
    category: "testing",
    ...
    correctAnswer: 1,
    explanation:
      "Property-Based Testing genera inputs automáticamente verificando que propiedades invariantes se cumplan. Herramientas: QuickCheck, jqwik.",
  },
  ...
  // ============== IDS: SECURITY QUESTIONS ==============
  {
    ...
    correctAnswer: 1,
    explanation:
      "Broken Access Control es el #1 en OWASP 2021. Ocurre cuando usuarios pueden acceder a recursos o funciones no autorizadas.",
  },
  {
    id: "sec-002",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "SQL Injection permite ejecutar SQL malicioso al no sanitizar inputs. Mitigación: usar prepared statements y parameterized queries.",
  },
  {
    id: "sec-003",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "XSS inyecta scripts que se ejecutan en el navegador de víctimas. Tipos: Stored, Reflected, DOM-based. Mitigación: escapar output, CSP.",
  },
  {
    id: "sec-004",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "CSRF engaña al navegador para enviar requests autenticados a sitios donde el usuario tiene sesión activa. Mitigación: tokens CSRF, SameSite cookies.",
  },
  {
    id: "sec-005",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "Vault gestiona secrets, tokens, passwords, certificados y claves de encriptación de forma centralizada y segura.",
  },
  {
    id: "sec-006",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "Least Privilege minimiza el riesgo otorgando solo los permisos estrictamente necesarios. Aplica a usuarios, servicios y aplicaciones.",
  },
  {
    id: "sec-007",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "SAST analiza código fuente en busca de vulnerabilidades sin ejecutar la aplicación. Herramientas: SonarQube, Checkmarx, Snyk.",
  },
  {
    id: "sec-008",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "DAST prueba aplicaciones en ejecución simulando ataques desde el exterior. Herramientas: OWASP ZAP, Burp Suite.",
  },
  {
    id: "sec-009",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "mTLS requiere que ambas partes (cliente y servidor) presenten certificados válidos, común en comunicación entre microservicios.",
  },
  {
    id: "sec-010",
    category: "security",
    ...
    correctAnswer: 1,
    explanation:
      "Zero Trust asume que ningún usuario o sistema es confiable por defecto. Principios: verify explicitly, least privilege, assume breach.",
  },
];
