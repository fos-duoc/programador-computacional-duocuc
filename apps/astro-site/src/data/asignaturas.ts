...
export const asignaturas: Record<string, Asignatura> = {
  ...
  "fundamentos-programacion": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura introductoria que establece las bases del pensamiento computacional y la resolución de problemas mediante algoritmos. Los estudiantes aprenden a diseñar, codificar y depurar programas utilizando Python como lenguaje principal.",
    proposito:
      "Desarrollar en el estudiante la capacidad de análisis y resolución de problemas mediante la construcción de algoritmos y su implementación en un lenguaje de programación, aplicando buenas prácticas de codificación.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Fundamentos del pensamiento computacional, diseño de algoritmos y primeros pasos en Python.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Control de flujo del programa mediante condicionales, bucles y modularización con funciones.",
        contenidos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Actividad Formativa 1",
        ponderacion: 0,
        descripcion: "Ejercicios de pseudocódigo y primeros programas",
      },
      {
        tipo: "Formativa",
        nombre: "Actividad Formativa 2",
        ponderacion: 0,
        descripcion: "Práctica de estructuras de control",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Desarrollo de programa con funciones",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Proyecto con estructuras de datos",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto integrador final",
      },
    ],
    prerrequisitos: [],
    ...
    proyectosSugeridos: [
      {
        ...
        descripcion:
          "Calculadora con operaciones basicas y avanzadas (raiz, potencia, trigonometria)",
        nivel: "principiante",
      ...
      },
      {
        ...
        descripcion:
          "Aplicacion de linea de comandos para crear, listar y completar tareas con persistencia",
        nivel: "intermedio",
      ...
      },
      {
        ...
        descripcion:
          "Herramienta que analiza archivos de texto: cuenta palabras, frecuencia, estadisticas",
        nivel: "intermedio",
        duracionEstimada: "2 semanas",
      },
      {
        ...
        descripcion:
          "Clasico juego del ahorcado con categorias de palabras y sistema de puntuacion",
        nivel: "principiante",
        duracionEstimada: "1 semana",
      },
    ],
    relevanciaProfesional: [
      {
        ...
        importancia: "alta",
        descripcion: "Python es uno de los lenguajes mas demandados para backend",
      },
      {
        rol: "Data Scientist",
        importancia: "alta",
        descripcion: "Base fundamental para analisis de datos y ML",
      },
      {
        rol: "DevOps Engineer",
        importancia: "media",
        descripcion: "Scripts de automatizacion y herramientas CLI",
      },
      {
        rol: "QA Automation",
        importancia: "alta",
        descripcion: "Python es el lenguaje preferido para testing automatizado",
      },
    ],
  },
  ...
  "modelamiento-datos": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce los fundamentos del diseño de bases de datos relacionales, desde el análisis de requerimientos hasta la implementación del modelo físico en un SGBD.",
    proposito:
      "Capacitar al estudiante en el análisis, diseño y documentación de modelos de datos que soporten los requerimientos de información de una organización, aplicando técnicas de normalización y estándares de modelamiento.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Actividad Formativa 1",
        ponderacion: 0,
        descripcion: "Diseño de diagrama E-R básico",
      },
      {
        tipo: "Formativa",
        nombre: "Actividad Formativa 2",
        ponderacion: 0,
        descripcion: "Ejercicios de normalización",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Modelo conceptual completo",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Normalización y modelo lógico",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto: Modelo físico implementado",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      ...
      {
        tipo: "Curso",
        nombre: "Database Design - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=ztHopE5Wnpc",
      },
      {
        tipo: "Tutorial",
        nombre: "Lucidchart ER Diagrams",
        url: "https://www.lucidchart.com/pages/er-diagrams",
      },
      {
        tipo: "Libro",
        nombre: "Database Design for Mere Mortals",
        url: "https://www.amazon.com/Database-Design-Mere-Mortals-Hands/dp/0136788041",
      },
      {
        tipo: "Video",
        nombre: "Normalización Explicada",
        url: "https://www.youtube.com/watch?v=GFQaEYEc8_8",
      },
      {
        tipo: "Práctica",
        nombre: "SQL Practice - W3Schools",
  ...
  antropologia: {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura de formación general que explora la condición humana desde una perspectiva antropológica, integrando dimensiones filosóficas, culturales y sociales para la formación integral del profesional.",
    proposito:
      "Promover la reflexión crítica sobre la condición humana, la diversidad cultural y los desafíos éticos contemporáneos, desarrollando competencias para el trabajo colaborativo en contextos multiculturales.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        ponderacion: 0,
        descripcion: "Aportes en debates y reflexiones",
      },
      {
        tipo: "Sumativa",
        nombre: "Ensayo reflexivo",
        ponderacion: 30,
        descripcion: "Ensayo sobre identidad y cultura",
      },
      {
        tipo: "Sumativa",
        nombre: "Trabajo grupal",
        ponderacion: 30,
        descripcion: "Investigación sobre diversidad cultural",
      },
      {
        tipo: "Sumativa",
        nombre: "Proyecto final",
        ponderacion: 40,
        descripcion: "Análisis ético de caso tecnológico",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      {
        tipo: "Video",
        nombre: "TED Talks sobre cultura",
        url: "https://www.ted.com/topics/culture",
      },
      {
        tipo: "Video",
        nombre: "Crash Course Philosophy",
        url: "https://www.youtube.com/playlist?list=PL8dPuuaLjXtNgK6MZucdYldNkMybYIHKR",
      },
      {
        tipo: "Artículo",
        nombre: "Stanford Encyclopedia of Philosophy",
        url: "https://plato.stanford.edu/",
      },
      {
        tipo: "Video",
        nombre: "School of Life - Philosophy",
      ...
      {
        tipo: "Libro",
        nombre: "Homo Deus - Yuval Noah Harari",
        url: "https://www.ynharari.com/book/homo-deus/",
      },
      {
        tipo: "Artículo",
        nombre: "AI Ethics Guidelines - UNESCO",
  ...
  "poo-i": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce el paradigma de Programación Orientada a Objetos utilizando Java como lenguaje principal. Los estudiantes aprenden a modelar problemas del mundo real mediante clases, objetos y los cuatro pilares de la POO.",
    proposito:
      "Desarrollar la capacidad de diseñar e implementar soluciones de software aplicando los principios fundamentales de la Programación Orientada a Objetos, utilizando Java como herramienta de implementación.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Actividad Formativa 1",
        ponderacion: 0,
        descripcion: "Creación de clases básicas",
      },
      {
        tipo: "Formativa",
        nombre: "Actividad Formativa 2",
        ponderacion: 0,
        descripcion: "Práctica de herencia",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 25,
        descripcion: "Clases, encapsulamiento, composición",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 35,
        descripcion: "Herencia y polimorfismo",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto integrador con interfaces",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Curso",
        nombre: "Java Programming - MOOC.fi",
        url: "https://java-programming.mooc.fi/",
      },
      {
        tipo: "Video",
        nombre: "Java Full Course - Bro Code",
        url: "https://www.youtube.com/watch?v=xk4_1vDrzzo",
      },
      {
        tipo: "Libro",
        nombre: "Head First Java",
      ...
      {
        tipo: "Video",
        nombre: "OOP in Java - freeCodeCamp",
    ...
    proyectosSugeridos: [
      {
        ...
        descripcion:
          "Sistema para gestionar libros, prestamos y usuarios usando herencia y polimorfismo",
        nivel: "intermedio",
      ...
      },
      {
        ...
        descripcion:
          "Jerarquia de empleados con diferentes roles y calculo de salarios polimorfico",
        nivel: "principiante",
        duracionEstimada: "1 semana",
      },
    ],
    relevanciaProfesional: [
      {
        ...
        importancia: "alta",
        descripcion: "Base fundamental para Spring Boot y frameworks empresariales",
      },
      {
        rol: "Desarrollador Android",
        importancia: "alta",
        descripcion: "Java es uno de los lenguajes principales para Android",
      },
      {
        rol: "Arquitecto de Software",
        importancia: "alta",
        descripcion: "POO es esencial para disenar sistemas escalables",
      },
      {
        rol: "Full Stack Developer",
        importancia: "media",
        descripcion: "Conocimientos transferibles a cualquier lenguaje OO",
      },
    ],
  },
  ...
  "computacion-nube": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce los conceptos fundamentales de la computación en la nube, modelos de servicio (IaaS, PaaS, SaaS) y despliegue de aplicaciones en proveedores cloud como AWS.",
    proposito:
      "Capacitar al estudiante en el uso de servicios cloud para el despliegue y administración de aplicaciones, comprendiendo los modelos de servicio y las mejores prácticas de arquitectura cloud.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs AWS Academy",
        ponderacion: 0,
        descripcion: "Laboratorios prácticos guiados",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Configuración de EC2 y S3",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Redes y bases de datos",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto: Despliegue de aplicación",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      ...
      {
        tipo: "Curso",
        nombre: "AWS Cloud Practitioner - freeCodeCamp",
    ...
    relevanciaProfesional: [
      {
        rol: "Cloud Engineer",
        importancia: "alta",
        descripcion: "AWS es el proveedor cloud mas demandado del mercado",
      },
      {
        rol: "DevOps Engineer",
        importancia: "alta",
        descripcion: "Infraestructura cloud es fundamental para CI/CD",
      },
      {
        rol: "Solutions Architect",
        importancia: "alta",
        descripcion: "Disenar soluciones cloud escalables y eficientes",
      },
      {
        rol: "Backend Developer",
        importancia: "media",
        descripcion: "Desplegar y gestionar aplicaciones en la nube",
      },
    ],
  },
  ...
  comunicacion: {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura de formación general orientada al desarrollo de competencias comunicativas esenciales para el desempeño profesional: comprensión lectora, producción escrita y comunicación oral efectiva.",
    proposito:
      "Desarrollar habilidades comunicativas que permitan al estudiante expresarse de manera clara, coherente y efectiva en contextos académicos y profesionales del área de tecnología.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Técnicas de lectura comprensiva, análisis crítico y síntesis de textos técnicos y profesionales.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Redacción de documentos profesionales, técnicos y comunicación escrita en entornos laborales.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Técnicas de presentación profesional, comunicación oral efectiva y manejo de audiencias.",
        contenidos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Ejercicios de comprensión",
        ponderacion: 0,
        descripcion: "Análisis de textos técnicos",
      },
      {
        tipo: "Sumativa",
        nombre: "Diagnóstico",
        ponderacion: 10,
        descripcion: "Evaluación inicial de habilidades",
      },
      {
        tipo: "Sumativa",
        nombre: "Informe escrito",
        ponderacion: 35,
        descripcion: "Redacción de documento técnico",
      },
      {
        tipo: "Sumativa",
        nombre: "Presentación oral",
        ponderacion: 55,
        descripcion: "Exposición de proyecto",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      ...
      {
        tipo: "Herramienta",
        nombre: "Grammarly - Corrector de gramática",
        url: "https://www.grammarly.com/",
      },
      {
        tipo: "Tutorial",
        nombre: "Technical Writing - Google Developers",
        url: "https://developers.google.com/tech-writing",
      },
      {
        tipo: "Curso",
        nombre: "Writing in the Sciences - Stanford",
        url: "https://www.coursera.org/learn/sciwrite",
      },
      {
        tipo: "Video",
        nombre: "TED Talks - Communication Skills",
        url: "https://www.ted.com/topics/communication",
      },
      {
        tipo: "Herramienta",
        nombre: "Hemingway Editor - Claridad de escritura",
        url: "https://hemingwayapp.com/",
      },
      {
        tipo: "Guía",
        nombre: "Purdue OWL - Writing Lab",
        url: "https://owl.purdue.edu/owl/general_writing/",
      },
      {
        tipo: "Curso",
        nombre: "Public Speaking - Coursera",
  ...
  "poo-ii": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que profundiza en el paradigma POO, introduciendo patrones de diseño, principios SOLID, acceso a bases de datos con JDBC y desarrollo de interfaces gráficas con JavaFX.",
    proposito:
      "Desarrollar aplicaciones de escritorio robustas aplicando patrones de diseño, principios SOLID y buenas prácticas de arquitectura de software utilizando Java.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Fundamentos de diseño de software orientado a objetos, principios SOLID y patrones creacionales GoF.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Conexión a bases de datos relacionales con JDBC, patrones de persistencia y manejo de transacciones.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Desarrollo de interfaces gráficas profesionales con JavaFX, Scene Builder y patrón MVC.",
        contenidos: [
    ...
    evaluaciones: [
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 1",
        ponderacion: 25,
        descripcion: "SOLID y patrones creacionales",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 35,
        descripcion: "JDBC y patrón DAO",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto JavaFX completo",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Práctica",
        nombre: "Baeldung - JDBC Tutorial",
        url: "https://www.baeldung.com/java-jdbc",
      },
      {
        tipo: "Video",
        nombre: "Design Patterns in Java - Derek Banas",
      ...
      {
        tipo: "Tutorial",
        nombre: "JUnit 5 User Guide",
        url: "https://junit.org/junit5/docs/current/user-guide/",
      },
      {
        tipo: "Práctica",
        nombre: "Exercism - Java Track",
  ...
  devops: {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce la cultura y prácticas DevOps: automatización, CI/CD, contenedores Docker, y gestión de infraestructura como código.",
    proposito:
      "Capacitar al estudiante en la implementación de prácticas DevOps para automatizar el ciclo de vida del desarrollo de software, mejorando la colaboración entre equipos de desarrollo y operaciones.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Cultura y principios DevOps, Git avanzado, estrategias de branching y automatización inicial.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Containerización de aplicaciones con Docker, Docker Compose y mejores prácticas de imágenes.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Pipelines completos de CI/CD, deployment automatizado y monitoreo básico de aplicaciones.",
        contenidos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs Docker",
        ponderacion: 0,
        descripcion: "Prácticas de containerización",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 25,
        descripcion: "Git avanzado y GitHub Actions básico",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 35,
        descripcion: "Docker y Docker Compose",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Pipeline CI/CD completo",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Tutorial",
        nombre: "GitHub Actions Documentation",
        url: "https://docs.github.com/en/actions",
      },
      { tipo: "Roadmap", nombre: "DevOps Roadmap 2025", url: "https://roadmap.sh/devops" },
      {
        tipo: "Video",
        nombre: "Docker Tutorial - TechWorld with Nana",
        url: "https://www.youtube.com/watch?v=3c-iBn73dDE",
      },
      {
        tipo: "Práctica",
        nombre: "Play with Docker Labs",
        url: "https://labs.play-with-docker.com/",
      },
      {
        tipo: "Curso",
        nombre: "Docker & Kubernetes - Udemy",
        url: "https://www.udemy.com/course/docker-and-kubernetes-the-complete-guide/",
      },
      {
        tipo: "Libro",
        nombre: "The DevOps Handbook",
        url: "https://www.amazon.com/DevOps-Handbook-World-Class-Reliability-Organizations/dp/1950508404",
      },
      {
        tipo: "Tutorial",
        nombre: "Learn GitHub Actions",
  ...
  etica: {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura de formación general que profundiza en la reflexión ética aplicada al ámbito profesional y tecnológico, abordando dilemas contemporáneos de la industria TI.",
    proposito:
      "Desarrollar el juicio ético del estudiante para enfrentar dilemas profesionales en el ámbito tecnológico, promoviendo una práctica responsable y comprometida con la sociedad.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Bases filosóficas, teorías éticas y su aplicación al ámbito profesional tecnológico.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Dilemas éticos específicos del sector tecnológico: privacidad, IA, propiedad intelectual.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Aplicación práctica de principios éticos en proyectos tecnológicos y tech for good.",
        contenidos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Participación en debates",
        ponderacion: 0,
        descripcion: "Aportes en discusiones éticas",
      },
      {
        tipo: "Sumativa",
        nombre: "Ensayo ético",
        ponderacion: 30,
        descripcion: "Análisis de dilema tecnológico",
      },
      {
        tipo: "Sumativa",
        nombre: "Caso de estudio",
        ponderacion: 30,
        descripcion: "Evaluación de caso real",
      },
      {
        tipo: "Sumativa",
        nombre: "Proyecto final",
        ponderacion: 40,
        descripcion: "Propuesta de tecnología ética",
      },
    ],
  ...
  "sql-consultas": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que desarrolla competencias avanzadas en consultas SQL, desde sentencias básicas hasta queries complejos con múltiples tablas, subconsultas y funciones de agregación.",
    proposito:
      "Capacitar al estudiante en la extracción y manipulación eficiente de datos mediante SQL, dominando desde consultas básicas hasta queries avanzados para análisis de información.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Sintaxis SQL básica, filtrado, ordenamiento y funciones integradas sobre tablas individuales.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 4-5",
        descripcion:
          "Consultas multi-tabla con diferentes tipos de JOIN y funciones de agregación para análisis.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Subconsultas, CTEs, funciones de ventana y técnicas avanzadas para análisis de datos.",
        contenidos: [
    ...
    evaluaciones: [
      {
        ...
        ponderacion: 0,
        descripcion: "Práctica de consultas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Consultas básicas y JOINs",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Agregaciones y subconsultas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto de análisis SQL",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Práctica",
        nombre: "LeetCode SQL Problems",
        url: "https://leetcode.com/problemset/database/",
      },
      {
        tipo: "Curso",
        nombre: "SQL for Data Science - Coursera",
        url: "https://www.coursera.org/learn/sql-for-data-science",
      },
      { tipo: "Práctica", nombre: "HackerRank SQL", url: "https://www.hackerrank.com/domains/sql" },
      {
        tipo: "Video",
        nombre: "SQL Tutorial - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=HXV3zeQKqGY",
      },
      {
        tipo: "Libro",
        nombre: "Learning SQL - Alan Beaulieu",
        url: "https://www.amazon.com/Learning-SQL-Generate-Manipulate-Retrieve/dp/1492057614",
      },
      {
        tipo: "Repositorio",
        nombre: "Materiales del Curso",
  ...
  "seguridad-informatica": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce los fundamentos de ciberseguridad, vulnerabilidades comunes en aplicaciones web (OWASP Top 10), y prácticas de desarrollo seguro.",
    proposito:
      "Desarrollar la capacidad de identificar, prevenir y mitigar vulnerabilidades de seguridad en aplicaciones de software, aplicando principios de seguridad desde el diseño.",
    objetivos: [
    ...
    experiencias: [
      {
        ...
        semanas: "Semana 1-3",
        descripcion:
          "Principios de seguridad de la información, tipos de amenazas y análisis de riesgo.",
        contenidos: [
      ...
      },
      {
        ...
        semanas: "Semana 6-8",
        descripcion:
          "Prácticas de desarrollo seguro, remediación de vulnerabilidades y criptografía aplicada.",
        contenidos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs de seguridad",
        ponderacion: 0,
        descripcion: "Prácticas en WebGoat",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Fundamentos y amenazas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "OWASP Top 10",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto de desarrollo seguro",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      ...
      {
        tipo: "Certificación",
        nombre: "Google Cybersecurity Certificate",
        url: "https://grow.google/certificates/cybersecurity/",
      },
      {
        tipo: "Práctica",
        nombre: "HackTheBox - Web Challenges",
        url: "https://www.hackthebox.com/",
      },
      {
        tipo: "Video",
        nombre: "LiveOverflow - Web Hacking",
        url: "https://www.youtube.com/c/LiveOverflow",
      },
      {
        tipo: "Libro",
        nombre: "The Web Application Hacker's Handbook",
  ...
  "sql-programacion": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que desarrolla competencias avanzadas en programación de bases de datos: procedimientos almacenados, funciones, triggers, cursores, optimización de rendimiento y administración de transacciones para implementar lógica de negocio robusta en el servidor de datos.",
    proposito:
      "Capacitar al estudiante en la programación avanzada de bases de datos relacionales para implementar lógica de negocio en el servidor, optimizar rendimiento de queries complejos, automatizar procesos de datos mediante triggers y procedimientos, y gestionar transacciones con garantías ACID.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs de programación",
        ponderacion: 0,
        descripcion: "Práctica de SP y funciones",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Triggers y cursores",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto optimización",
      },
    ],
  ...
  "cloud-native": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que profundiza en el desarrollo de aplicaciones cloud-native según los estándares CNCF, introduciendo Kubernetes como orquestador de contenedores, arquitecturas de microservicios, service mesh, observabilidad distribuida y patrones serverless para construir sistemas escalables, resilientes y portables.",
    proposito:
      "Capacitar al estudiante en el diseño, implementación y operación de aplicaciones nativas de la nube, aplicando los principios de los 12-Factor Apps, orquestación de contenedores con Kubernetes, patrones de microservicios y estrategias de observabilidad para sistemas distribuidos.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs Kubernetes",
        ponderacion: 0,
        descripcion: "Prácticas de orquestación",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Kubernetes fundamentals",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto cloud-native",
      },
    ],
    ...
    recursos: [
      {
        tipo: "Documentación",
        nombre: "Kubernetes Official Docs",
        url: "https://kubernetes.io/docs/",
      },
      { tipo: "Guía", nombre: "CNCF Trail Map", url: "https://landscape.cncf.io/" },
      {
        tipo: "Tutorial",
        nombre: "Kubernetes Learning Path - Microsoft",
        url: "https://learn.microsoft.com/en-us/training/paths/intro-to-kubernetes-on-azure/",
      },
      {
        tipo: "Video",
        nombre: "Kubernetes Course - TechWorld with Nana",
        url: "https://www.youtube.com/watch?v=X48VuDVv0do",
      },
      { tipo: "Libro", nombre: "12-Factor App Methodology", url: "https://12factor.net/" },
      {
        tipo: "Práctica",
        nombre: "KillerCoda - Interactive K8s Labs",
        url: "https://killercoda.com/playgrounds/scenario/kubernetes",
      },
      {
        tipo: "Curso",
        nombre: "Kubernetes Basics - Udacity",
        url: "https://www.udacity.com/course/scalable-microservices-with-kubernetes--ud615",
      },
      {
        tipo: "Certificación",
        nombre: "CKAD Prep - Linux Foundation",
  ...
  "ingenieria-requisitos": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que desarrolla competencias completas en el ciclo de vida de requisitos de software: elicitación con stakeholders, análisis y modelado, especificación según estándares IEEE/ISO, validación, trazabilidad y gestión del cambio para proyectos de desarrollo de software.",
    proposito:
      "Capacitar al estudiante en las técnicas, metodologías y herramientas profesionales para gestionar requisitos de software de manera integral, desde la identificación de stakeholders y elicitación hasta la documentación formal, validación continua y gestión de cambios a lo largo del ciclo de vida del proyecto.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Ejercicios de elicitación",
        ponderacion: 0,
        descripcion: "Práctica de técnicas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Elicitación y análisis",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Especificación y modelado",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto SRS completo",
      },
    ],
    prerrequisitos: [],
    ...
    recursos: [
      {
        tipo: "Estándar",
        nombre: "IEEE 830 / ISO 29148 Standard",
        url: "https://standards.ieee.org/",
      },
      {
        tipo: "Libro",
        nombre: "Software Requirements - Karl Wiegers",
        url: "https://www.processimpact.com/books.html",
      },
      {
        tipo: "Tutorial",
        nombre: "User Story Mapping - Jeff Patton",
        url: "https://www.jpattonassociates.com/user-story-mapping/",
      },
      {
        tipo: "Herramienta",
        nombre: "Jira Software Guide",
        url: "https://www.atlassian.com/software/jira/guides",
      },
      {
        tipo: "Video",
        nombre: "Requirements Engineering Course - Udacity",
      ...
      {
        tipo: "Guía",
        nombre: "Atlassian Agile Requirements",
        url: "https://www.atlassian.com/agile/product-management/requirements",
      },
      {
        tipo: "Plantilla",
        nombre: "SRS Template - IEEE",
        url: "https://www.templatelab.com/srs-software-requirements-specification/",
      },
      {
        tipo: "Repositorio",
        nombre: "Materiales del Curso",
  ...
  "backend-i": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce el desarrollo profesional de APIs REST con Spring Boot, incluyendo arquitectura de capas, inyección de dependencias, persistencia con JPA/Hibernate, validación robusta, manejo de excepciones y documentación con OpenAPI/Swagger para construir servicios backend escalables.",
    proposito:
      "Capacitar al estudiante en el desarrollo de servicios backend robustos y mantenibles utilizando Spring Boot, aplicando patrones de arquitectura empresarial, buenas prácticas de diseño de APIs REST y técnicas de persistencia con Spring Data JPA.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs Spring Boot",
        ponderacion: 0,
        descripcion: "Prácticas guiadas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "API REST básica",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Persistencia JPA",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "API completa documentada",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "Spring Boot Full Course - Amigoscode",
        url: "https://www.youtube.com/watch?v=9SGDpanrc8U",
      },
      {
        tipo: "Curso",
        nombre: "Spring Boot Masterclass - Udemy",
        url: "https://www.udemy.com/course/spring-hibernate-tutorial/",
      },
      {
        tipo: "Documentación",
        nombre: "Spring Data JPA Reference",
      ...
      {
        tipo: "Práctica",
        nombre: "Spring Boot REST API Best Practices",
  ...
  "ingenieria-software-i": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce metodologías ágiles con énfasis en el framework Scrum, gestión de proyectos de software, técnicas de estimación, planificación y seguimiento de sprints, y el uso de herramientas profesionales para la gestión efectiva de equipos de desarrollo.",
    proposito:
      "Capacitar al estudiante en la aplicación práctica de metodologías ágiles, especialmente Scrum, para la gestión efectiva de proyectos de desarrollo de software, desarrollando habilidades de facilitación, estimación y uso de herramientas de gestión ágil.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Simulaciones Scrum",
        ponderacion: 0,
        descripcion: "Práctica de ceremonias",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Fundamentos Scrum",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Gestión de Backlog",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto Sprint completo",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "Scrum in 16 Minutes",
        url: "https://www.youtube.com/watch?v=vuBFzAdaHDY",
      },
      {
        tipo: "Curso",
        nombre: "Agile with Atlassian Jira - Coursera",
        url: "https://www.coursera.org/learn/agile-atlassian-jira",
      },
      {
        tipo: "Libro",
        nombre: "Scrum: The Art of Doing Twice the Work",
        url: "https://www.scruminc.com/new-scrum-the-book/",
      },
      {
        tipo: "Práctica",
        nombre: "Scrum Simulation - Lego4Scrum",
        url: "https://www.lego4scrum.com/",
      },
      {
        tipo: "Herramienta",
        nombre: "Planning Poker Online",
  ...
  "backend-ii-iii": {
    ...
    horasPracticas: 6,
    descripcion:
      "Asignatura avanzada de backend que cubre seguridad empresarial con Spring Security, autenticación/autorización con JWT y OAuth2, testing automatizado con JUnit/Mockito, caching con Redis, mensajería asíncrona con RabbitMQ/Kafka, y patrones avanzados de arquitectura para construir APIs robustas y escalables.",
    proposito:
      "Desarrollar competencias avanzadas en desarrollo backend empresarial, incluyendo implementación de seguridad robusta, testing automatizado integral, optimización de rendimiento con caching, y comunicación asíncrona para construir APIs de alta disponibilidad.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs de seguridad",
        ponderacion: 0,
        descripcion: "Prácticas de Spring Security",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Seguridad y JWT",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
  ...
  "ingenieria-software-ii": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que profundiza en calidad de software, testing avanzado con múltiples frameworks, automatización de pruebas E2E, testing de rendimiento y seguridad, integración continua con quality gates, y mejora continua de procesos de desarrollo según estándares ISTQB.",
    proposito:
      "Desarrollar competencias integrales en aseguramiento de calidad de software, incluyendo diseño de estrategias de testing, automatización con frameworks modernos, testing de rendimiento y seguridad, y gestión de calidad en pipelines CI/CD para entregar software de alta calidad.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs de testing",
        ponderacion: 0,
        descripcion: "Práctica de automatización",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Estrategias de testing",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Automatización E2E",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Plan de calidad",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Documentación",
        nombre: "Playwright Docs",
        url: "https://playwright.dev/docs/intro",
      },
      {
        tipo: "Video",
        nombre: "Playwright Full Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=VELWdMWQN8c",
      },
      {
        tipo: "Herramienta",
  ...
  "frontend-i-ii": {
    ...
    horasPracticas: 6,
    descripcion:
      "Asignatura que cubre desarrollo frontend moderno con React, incluyendo componentes, estado, hooks, routing y consumo de APIs.",
    proposito:
      "Capacitar al estudiante en el desarrollo de interfaces de usuario modernas y reactivas utilizando React y su ecosistema.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs React",
        ponderacion: 0,
        descripcion: "Prácticas de componentes",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Componentes y hooks",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Estado y routing",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto SPA",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "React 18 Full Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=bMknfKXIFA8",
      },
      {
        tipo: "Documentación",
        nombre: "TanStack Query Docs",
        url: "https://tanstack.com/query/latest",
      },
      {
        tipo: "Tutorial",
        nombre: "Testing Library Recipes",
        url: "https://testing-library.com/docs/react-testing-library/intro/",
      },
      {
        tipo: "Herramienta",
        nombre: "Storybook for React",
        url: "https://storybook.js.org/docs/react/get-started/introduction",
      },
      {
        tipo: "Práctica",
        nombre: "Frontend Mentor Challenges",
  ...
  "arquitectura-software": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce patrones de arquitectura de software, diseño de sistemas distribuidos y documentación arquitectónica.",
    proposito:
      "Desarrollar la capacidad de diseñar y documentar arquitecturas de software escalables, mantenibles y alineadas con los requerimientos del negocio.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Análisis de arquitecturas",
        ponderacion: 0,
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Estilos y patrones",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Documentación arquitectónica",
      },
    ],
    ...
    recursos: [
      {
        tipo: "Libro",
        nombre: "Fundamentals of Software Architecture - Richards & Ford",
      ...
      {
        tipo: "Video",
        nombre: "Software Architecture Fundamentals - Mark Richards",
        url: "https://www.youtube.com/watch?v=DngAZyWMGR0",
      },
      {
        tipo: "Curso",
        nombre: "Developer to Architect - Mark Richards",
        url: "https://developertoarchitect.com/",
      },
      {
        tipo: "Repositorio",
        nombre: "Materiales del Curso",
  ...
  "mobile-i": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce el desarrollo de aplicaciones móviles multiplataforma con React Native o Flutter.",
    proposito:
      "Capacitar al estudiante en el desarrollo de aplicaciones móviles nativas multiplataforma, aplicando conocimientos previos de frontend.",
    objetivos: [
    ...
    evaluaciones: [
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Fundamentos RN",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Navegación y estado",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "App móvil completa",
      },
    ],
  ...
  "frontend-iii": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura avanzada de frontend que cubre Next.js, SSR/SSG, optimización de rendimiento y accesibilidad.",
    proposito:
      "Desarrollar competencias avanzadas en frontend moderno, incluyendo frameworks full-stack, optimización y mejores prácticas de la industria.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs Next.js",
        ponderacion: 0,
        descripcion: "Prácticas de renderizado",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Next.js fundamentals",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Data fetching",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
  ...
  "mobile-ii": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura avanzada de desarrollo móvil que cubre patrones de arquitectura, testing, CI/CD y optimización de aplicaciones.",
    proposito:
      "Desarrollar competencias avanzadas en desarrollo móvil, incluyendo arquitectura escalable, testing automatizado y optimización de rendimiento.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs avanzados",
        ponderacion: 0,
        descripcion: "Prácticas de arquitectura",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Arquitectura mobile",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Testing y CI/CD",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "App producción",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Servicio",
        nombre: "Firebase for Mobile",
        url: "https://firebase.google.com/docs/guides",
      },
      {
        tipo: "Herramienta",
        nombre: "Sentry for React Native",
        url: "https://docs.sentry.io/platforms/react-native/",
      },
      {
        tipo: "Video",
        nombre: "React Native Architecture Deep Dive",
  ...
  "taller-titulo": {
    ...
    horasPracticas: 8,
    descripcion:
      "Asignatura integradora donde los estudiantes desarrollan un proyecto de software completo, aplicando todos los conocimientos adquiridos durante la carrera.",
    proposito:
      "Demostrar las competencias profesionales del estudiante mediante el desarrollo de un proyecto de software que resuelva una problemática real, siguiendo metodologías profesionales.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Propuesta",
        ponderacion: 15,
        descripcion: "Documento de propuesta",
      },
      ...
      { tipo: "Sumativa", nombre: "Avance 2", ponderacion: 20, descripcion: "Features completas" },
      {
        ...
        ponderacion: 25,
        descripcion: "Software terminado",
      },
      {
        tipo: "Sumativa",
        nombre: "Defensa",
        ponderacion: 20,
        descripcion: "Presentación ante tribunal",
      },
    ],
    ...
    recursos: [
      {
        tipo: "Guía",
        nombre: "GitHub README Best Practices",
        url: "https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-readmes",
      },
      {
        tipo: "Template",
        nombre: "Awesome README Templates",
        url: "https://github.com/matiassingers/awesome-readme",
      },
      {
        tipo: "Guía",
        nombre: "Write the Docs - Documentation Guide",
        url: "https://www.writethedocs.org/guide/",
      },
      {
        tipo: "Video",
        nombre: "How to Present Software Projects",
        url: "https://www.youtube.com/watch?v=3rFMYMJd1Wc",
      },
      { tipo: "Herramienta", nombre: "Canva para Presentaciones", url: "https://www.canva.com/" },
      {
        tipo: "Tutorial",
        nombre: "Technical Writing by Google",
        url: "https://developers.google.com/tech-writing",
      },
      {
        tipo: "Guía",
        nombre: "IEEE 830 SRS Standard",
  ...
  "fullstack-i": {
    ...
    horasPracticas: 6,
    descripcion:
      "Asignatura que integra desarrollo frontend y backend, cubriendo arquitecturas modernas, APIs RESTful avanzadas y patrones de integración fullstack.",
    proposito:
      "Desarrollar competencias integrales en desarrollo fullstack, capacitando al estudiante para construir aplicaciones web completas desde el frontend hasta el backend.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs Fullstack",
        ponderacion: 0,
        descripcion: "Integraciones prácticas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Arquitectura fullstack",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Autenticación E2E",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto fullstack",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Tutorial",
        nombre: "Turborepo Handbook",
        url: "https://turbo.build/repo/docs/handbook",
      },
      {
        tipo: "Video",
        nombre: "NestJS Full Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=GHTA143_b-s",
      },
      {
        tipo: "Documentación",
        nombre: "Socket.io Documentation",
      ...
      {
        tipo: "Video",
        nombre: "JWT Authentication Deep Dive",
  ...
  "bd-aplicada": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que profundiza en bases de datos NoSQL, data modeling avanzado, optimización de queries y gestión de datos a escala.",
    proposito:
      "Desarrollar competencias avanzadas en diseño y gestión de bases de datos, incluyendo NoSQL, optimización y arquitecturas de datos modernas.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs NoSQL",
        ponderacion: 0,
        descripcion: "Prácticas de modelado",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "MongoDB y NoSQL",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Redis y caching",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto multi-DB",
      },
    ],
    ...
    recursos: [
      {
        tipo: "Documentación",
        nombre: "MongoDB Documentation",
        url: "https://www.mongodb.com/docs/",
      },
      { tipo: "Documentación", nombre: "Redis Documentation", url: "https://redis.io/docs/" },
      {
        tipo: "Curso",
        nombre: "MongoDB University (Gratis)",
        url: "https://university.mongodb.com/",
      },
      {
        tipo: "Video",
        nombre: "MongoDB Full Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=c2M-rlkkT5o",
      },
      {
        tipo: "Tutorial",
        nombre: "Redis Crash Course",
        url: "https://www.youtube.com/watch?v=jgpVdJB2sKQ",
      },
      {
        tipo: "Documentación",
        nombre: "Mongoose ODM Guide",
        url: "https://mongoosejs.com/docs/guide.html",
      },
      {
        tipo: "Libro",
        nombre: "MongoDB: The Definitive Guide",
        url: "https://www.oreilly.com/library/view/mongodb-the-definitive/9781491954461/",
      },
  ...
  "fullstack-ii": {
    ...
    horasPracticas: 6,
    descripcion:
      "Asignatura avanzada de desarrollo fullstack que cubre microservicios, event-driven architecture, testing E2E y observabilidad.",
    proposito:
      "Profundizar en arquitecturas fullstack avanzadas, preparando al estudiante para desarrollar sistemas distribuidos y aplicaciones enterprise.",
    objetivos: [
      "Diseñar arquitecturas de microservicios",
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs Microservicios",
        ponderacion: 0,
        descripcion: "Prácticas distribuidas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
    ...
    recursos: [
      ...
      {
        tipo: "Libro",
        nombre: "Designing Data-Intensive Applications",
        url: "https://dataintensive.net/",
      },
      {
        tipo: "Documentación",
        nombre: "RabbitMQ Tutorials",
        url: "https://www.rabbitmq.com/tutorials",
      },
      {
        tipo: "Documentación",
        nombre: "Apache Kafka Documentation",
        url: "https://kafka.apache.org/documentation/",
      },
      {
        tipo: "Tutorial",
        nombre: "Playwright Testing Guide",
        url: "https://playwright.dev/docs/intro",
      },
      {
        tipo: "Video",
        nombre: "Microservices Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=Cy9fAvsXGZA",
      },
      {
        tipo: "Tutorial",
        nombre: "Prometheus + Grafana Monitoring",
        url: "https://prometheus.io/docs/tutorials/getting_started/",
      },
      {
        tipo: "Curso",
        nombre: "Event-Driven Architecture - Udemy",
        url: "https://www.udemy.com/course/event-driven-microservices-spring-boot-kafka/",
      },
      {
        tipo: "Repositorio",
        nombre: "Materiales del Curso",
  ...
  "cloud-computing": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que profundiza en servicios cloud, IaC (Infrastructure as Code), serverless y arquitecturas cloud-native.",
    proposito:
      "Desarrollar competencias avanzadas en cloud computing, preparando al estudiante para diseñar e implementar soluciones escalables en la nube.",
    objetivos: [
    ...
    evaluaciones: [
      { tipo: "Formativa", nombre: "Labs Cloud", ponderacion: 0, descripcion: "Prácticas en AWS" },
      {
        ...
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Servicios core",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "IaC con Terraform",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Proyecto serverless",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Documentación",
        nombre: "Terraform AWS Provider",
        url: "https://registry.terraform.io/providers/hashicorp/aws/latest/docs",
      },
      {
        tipo: "Tutorial",
        nombre: "AWS Well-Architected Labs",
        url: "https://www.wellarchitectedlabs.com/",
      },
      {
        tipo: "Video",
        nombre: "AWS Full Course - freeCodeCamp",
        url: "https://www.youtube.com/watch?v=ulprqHHWlng",
      },
      {
        tipo: "Curso",
        nombre: "Terraform Associate Certification",
  ...
  "fullstack-iii": {
    ...
    horasPracticas: 6,
    descripcion:
      "Asignatura de especialización fullstack que cubre GraphQL, real-time systems, performance optimization y arquitecturas avanzadas.",
    proposito:
      "Consolidar y especializar las competencias fullstack del estudiante, preparándolo para liderar proyectos de desarrollo complejo.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs Avanzados",
        ponderacion: 0,
        descripcion: "Prácticas especializadas",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
  ...
  "app-moviles": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura avanzada de desarrollo móvil que cubre Flutter, desarrollo nativo avanzado, offline-first y publicación en stores.",
    proposito:
      "Especializar al estudiante en desarrollo móvil multiplataforma, preparándolo para crear aplicaciones móviles profesionales.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs Flutter",
        ponderacion: 0,
        descripcion: "Prácticas móviles",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Flutter basics",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Offline-first",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "App completa",
      },
    ],
  ...
  "cloud-native-i": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que introduce desarrollo cloud-native con Kubernetes, service mesh y observabilidad avanzada.",
    proposito:
      "Desarrollar competencias en arquitecturas cloud-native, preparando al estudiante para operar aplicaciones en Kubernetes.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs K8s",
        ponderacion: 0,
        descripcion: "Prácticas en cluster",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Kubernetes basics",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Helm y GitOps",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Cloud-native app",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Certificación",
        nombre: "CKA Certification",
        url: "https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/",
      },
      {
        tipo: "Certificación",
        nombre: "CKAD Certification",
        url: "https://training.linuxfoundation.org/certification/certified-kubernetes-application-developer-ckad/",
      },
      {
        tipo: "Video",
        nombre: "Kubernetes Full Course - TechWorld with Nana",
        url: "https://www.youtube.com/watch?v=X48VuDVv0do",
      },
      {
        tipo: "Tutorial",
        nombre: "CKAD Exercises - GitHub",
        url: "https://github.com/dgkanatsios/CKAD-exercises",
      },
      {
        tipo: "Práctica",
        nombre: "Killercoda K8s Labs",
        url: "https://killercoda.com/playgrounds/scenario/kubernetes",
      },
      {
        tipo: "Repositorio",
  ...
  "cloud-native-ii": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura avanzada de cloud-native que cubre multi-cluster, disaster recovery, security y platform engineering.",
    proposito:
      "Profundizar en operaciones cloud-native avanzadas, preparando al estudiante para roles de SRE y Platform Engineering.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Labs Avanzados",
        ponderacion: 0,
        descripcion: "Prácticas enterprise",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Multi-cluster",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
  ...
  "seguridad-calidad": {
    ...
    horasPracticas: 4,
    descripcion:
      "Asignatura que integra seguridad de aplicaciones (AppSec) y calidad de software, cubriendo OWASP, SAST/DAST y métricas de calidad.",
    proposito:
      "Desarrollar competencias en seguridad y calidad de software, preparando al estudiante para crear aplicaciones seguras y de alta calidad.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs Security",
        ponderacion: 0,
        descripcion: "Prácticas de seguridad",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "AppSec fundamentals",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Security testing",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "DevSecOps pipeline",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Curso",
        nombre: "OWASP Top 10 Training",
        url: "https://owasp.org/www-project-web-security-testing-guide/",
      },
      {
        tipo: "Herramienta",
        nombre: "SonarQube Documentation",
        url: "https://docs.sonarqube.org/",
      },
      { tipo: "Tutorial", nombre: "Snyk Learn Security", url: "https://learn.snyk.io/" },
      {
        tipo: "Video",
        nombre: "Web Security - Computerphile",
        url: "https://www.youtube.com/playlist?list=PLzH6n4zXuckrLBxd2MVWH_a6mlN0cYuOL",
      },
      {
        tipo: "Certificación",
      ...
      {
        tipo: "Libro",
        nombre: "The Web Application Hackers Handbook",
  ...
  "evaluacion-proyectos-sw": {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura enfocada en técnicas de estimación, métricas de calidad y evaluación de proyectos de software. Incluye análisis de viabilidad, ROI, TCO y metodologías de valoración técnica.",
    proposito:
      "Desarrollar competencias para evaluar proyectos de software de manera objetiva, utilizando métricas, indicadores y técnicas de estimación profesionales.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Labs de métricas",
        ponderacion: 0,
        descripcion: "Prácticas de medición",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Técnicas de estimación",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Métricas y dashboards",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Business case completo",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Framework",
        nombre: "SPACE Productivity Framework",
        url: "https://queue.acm.org/detail.cfm?id=3454124",
      },
      {
        tipo: "Libro",
        nombre: "Accelerate (Forsgren, Humble, Kim)",
        url: "https://itrevolution.com/book/accelerate/",
      },
      {
        tipo: "Libro",
        nombre: "Software Estimation: Demystifying the Black Art",
        url: "https://www.amazon.com/Software-Estimation-Demystifying-Black-Art/dp/0735605351",
      },
      {
        tipo: "Herramienta",
        nombre: "SonarQube Documentation",
      ...
      {
        tipo: "Certificación",
        nombre: "PMI-ACP Certification",
        url: "https://www.pmi.org/certifications/agile-acp",
      },
      {
        tipo: "Video",
        nombre: "Agile Estimating - Mountain Goat Software",
        url: "https://www.mountaingoatsoftware.com/presentations/agile-estimating",
      },
      {
        tipo: "Tutorial",
        nombre: "COCOMO II Model Tutorial",
  ...
  "gestion-proyectos-sw": {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura enfocada en metodologías ágiles a escala, liderazgo de equipos técnicos, gestión de stakeholders y comunicación efectiva en proyectos de desarrollo de software.",
    proposito:
      "Desarrollar competencias de liderazgo y gestión para dirigir equipos de desarrollo de software, aplicando frameworks ágiles y técnicas de comunicación profesional.",
    objetivos: [
    ...
    evaluaciones: [
      {
        ...
        nombre: "Workshops",
        ponderacion: 0,
        descripcion: "Dinámicas de liderazgo",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Agile at scale",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
      ...
      },
      {
        ...
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Plan de gestión completo",
      },
    ],
    prerrequisitos: ["Ing. Software II"],
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "Google Project Management - Coursera",
        url: "https://www.coursera.org/professional-certificates/google-project-management",
      },
      {
        tipo: "Podcast",
        nombre: "Software Engineering Daily",
  ...
  "etica-profesional": {
    ...
    horasPracticas: 2,
    descripcion:
      "Asignatura que profundiza en ética profesional, responsabilidad social, privacidad de datos y aspectos legales en tecnología.",
    proposito:
      "Formar profesionales éticos y responsables, conscientes del impacto social de la tecnología y las regulaciones vigentes.",
    objetivos: [
    ...
    evaluaciones: [
      { tipo: "Formativa", nombre: "Debates", ponderacion: 0, descripcion: "Discusiones éticas" },
      {
        ...
        nombre: "Evaluación Sumativa 1",
        ponderacion: 30,
        descripcion: "Fundamentos éticos",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 2",
        ponderacion: 30,
        descripcion: "Privacidad",
      },
      {
        tipo: "Sumativa",
        nombre: "Evaluación Sumativa 3",
        ponderacion: 40,
        descripcion: "Ethical review",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Framework",
        nombre: "EU Trustworthy AI Guidelines",
        url: "https://digital-strategy.ec.europa.eu/en/library/ethics-guidelines-trustworthy-ai",
      },
      {
        tipo: "Tutorial",
        nombre: "Microsoft Responsible AI",
        url: "https://www.microsoft.com/en-us/ai/responsible-ai",
      },
      ...
      {
        tipo: "Video",
        nombre: "Ethics in Tech - TED Talks",
  ...
  "taller-aplicado-sw": {
    ...
    horasPracticas: 10,
    descripcion:
      "Asignatura de cierre de carrera donde los estudiantes desarrollan un proyecto integrador de ingeniería de software con cliente real.",
    proposito:
      "Consolidar todas las competencias de la carrera mediante el desarrollo de un proyecto real que demuestre las habilidades del ingeniero de software.",
    objetivos: [
    ...
    evaluaciones: [
      {
        tipo: "Formativa",
        nombre: "Sprint reviews",
        ponderacion: 0,
        descripcion: "Demos de sprint",
      },
      ...
      },
      {
        ...
        ponderacion: 50,
        descripcion: "Proyecto completo y defensa",
      },
    ],
    ...
    recursos: [
      ...
      {
        tipo: "Video",
        nombre: "How to Present Technical Projects",
        url: "https://www.youtube.com/watch?v=Unzc731iCUY",
      },
      {
        tipo: "Tutorial",
        nombre: "Git Workflows - Atlassian",
